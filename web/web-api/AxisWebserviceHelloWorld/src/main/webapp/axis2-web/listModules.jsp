...
%>
<h3>
    <font color="red">Faulty Modules</font>
</h3>
<%
...
%><a
        href="errorModule.jsp?moduleName=<%=faultyModuleName%>"><%=faultyModuleName%>
</a>
<%
        }
    }
...
%>
<h2>
    <font color="blue">There are no modules deployed in the
        system.</font>
</h2>
<%
    }
