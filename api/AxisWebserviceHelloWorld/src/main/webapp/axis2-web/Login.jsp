...
<body onload="javascript:document.LoginForm.userName.focus();">
    ...
    <table class="FULL_BLANK">
        <tr>
            <td valign="top">
                <h2>Welcome :</h2>
                <p>Welcome to the Axis2 administration console. From
                    inside the Axis2 administration console you can :</p>
                <ul style="list-style: none;" class="loginUL">
                    <li>Check on the health of your Axis2
                        deployment.</li>
                    <li>Change any parameters at run time.</li>
                    <li>Upload new services into Axis2 [Service
                        hot-deployment].</li>
                </ul> <font color="orange">Warning: Please note that
                    configuration changes done through the
                    administration console will be lost when the server
                    is restarted.</font>
            </td>
                    ...
                    <table class="LOG_IN_FORM">
                        ...
                        <tr>
                            <td align="center" colspan="2"><font
                                color="red">&nbsp;<% if (request.getAttribute("errorMessage") != null) {%><%= request.getAttribute("errorMessage")%>
                                    <% } %>&nbsp;
                            </font></td>
                        </tr>
                    </table>
