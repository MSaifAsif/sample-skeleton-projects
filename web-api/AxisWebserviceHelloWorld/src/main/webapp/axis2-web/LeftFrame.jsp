...
<table width="100%" style="border-right: 1px solid #CCCCCC;">
    ...
    <tr>
        <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td><a href="axis2-admin/listModules">Available Modules</a></td>
    </tr>
    <tr>
        <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
    ...
    <tr>
        <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td><a href="axis2-admin/listPhases">Available Phases</a></td>
    </tr>
    <tr>
        <td colspan="2"><b>Execution Chains</b></td>
    </tr>
    <tr>
        <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
    ...
    <tr>
        <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td><a href="axis2-admin/engageToService">For a Service</a>
        </td>
    </tr>
    ...
    <tr>
        <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td><a href="axis2-admin/listContexts">View Hierarchy</a></td>
    </tr>
</table>
